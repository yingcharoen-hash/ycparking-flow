    ...
    let htmlContent = `
      <div style="font-family: 'Sarabun', sans-serif; padding: 10px; color: #333;">
        ...
        <div style="text-align: center; margin-top: 5px;">
          ...
          ${(data.photoSelfie && data.photoSelfie.startsWith('data:image')) ? '<img src="' + data.photoSelfie + '" style="height:120px; border-radius:8px; margin-top:5px;">' : '<span style="color:#888;">ไม่มีรูปถ่าย</span>'}
        </div>
